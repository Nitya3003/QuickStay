...
const BookIcon = () => (
    <svg 
    className="w-4 h-4 text-gray-700" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" 
    ...
    return (
        <nav className={`fixed top-0 left-0 w-full flex items-center justify-between px-4 md:px-16 lg:px-24 xl:px-32 transition-all duration-500 z-50 ${isScrolled ? "bg-white/80 shadow-md text-gray-700 backdrop-blur-lg py-3 md:py-4" : "py-4 md:py-6"}`}>
            ...
            {user && <UserButton>
                ...
                <img onClick={() => setIsMenuOpen(!isMenuOpen)} src={assets.menuIcon} alt="close" className= {`${isScrolled && 'invert'} h-4`}/>
            </div>
